...
contract('SupplyChain', function(accounts) {
    ...
    const productPrice = web3.utils .toWei(money.toString() , "ether")
    var itemState = 0
    ...
    it("Testing smart contract function packItem() that allows a farmer to pack coffee", async() => {
        ...
        //var myEvent = supplyChain.Packed({}, (err,event) => {eventEmitted = true})
        //event.watch((err, res) => {
        //    eventEmitted = true
        //})
    ...
    it("Testing smart contract function sellItem() that allows a farmer to sell coffee", async() => {
        ...
        //var myEvent = supplyChain.ForSale({}, (err,event) => {eventEmitted = true})
        //event.watch((err, res) => {
        ///    eventEmitted = true
        //})
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        //var myEvent = supplyChain.Sold({}, (err,event) => {eventEmitted = true})
        //event.watch((err,res) => {
        //    eventEmitted = true
        //})
    ...
    it("Testing smart contract function shipItem() that allows a distributor to ship coffee", async() => {
        ...
        //var myEvent = supplyChain.Shipped({}, (err,event) => {eventEmitted = true})
        //event.watch((err,res) => {
        //    eventEmitted = true
        //})
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        //var myEvent = supplyChain.Received({}, (err,event) => {eventEmitted = true})
        //event.watch((err,res) => {
        //    eventEmitted = true
        //})
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        //var myEvent = supplyChain.Purchased({}, (err,event) => {eventEmitted = true})
        //event.watch((err,res) => {
        //    eventEmitted = true
        //})
